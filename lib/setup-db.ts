...
// Initial peptides data (from existing peptides.js)
const PEPTIDES = [
...
// Initial prices (from existing data in peptides.js)
...
export async function setupDatabase() {
  ...
  // Create prices table (append-only for historical tracking)
  await sql`
  ...
  // Create index for fast lookups of latest prices
  await sql`
